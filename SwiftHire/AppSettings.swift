...
class AppSettings {
    ...
    func dashboardTitleText() -> String {
        guard let setting = settingData?["DashboardTitleText"] as? String else {
            return "" }
            return setting
        }
    
    func logoutButtonText() -> String {
        guard let setting = settingData?["LogoutButtonText"] as? String else {
            return "" }
        return setting
    }
    
    func selectPDFButtonText() -> String {
        guard let setting = settingData?["SelectPDFButtonText"] as? String else {
            return "" }
        return setting
    }
    
    func submitButtonText() -> String {
        guard let setting = settingData?["SubmitButtonText"] as? String else {
            return "" }
        return setting
    }
    
    func pdfPlaceholderText() -> String {
        guard let setting = settingData?["PDFPlaceholderText"] as? String else {
            return "" }
        return setting
    }
    
    func profileScreenTitle() -> String {
        guard let setting = settingData?["ProfileScreenTitle"] as? String else {
            return "" }
        return setting
    }
