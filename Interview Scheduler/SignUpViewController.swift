...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        confirmPasswordTextField.layer.borderColor = AppSettings().backgroundColor().cgColor
        ...
        alreadyHaveAccountLabel.textColor = AppSettings().secondaryColor()
        alreadyHaveAccountLabel.backgroundColor = AppSettings().primaryColor()
    ...
    @objc func signUpButtonTapped() {
        ...
        print("SignupDetails:\(user)")
        // Save user to the database
        if saveUserToDatabase(user) {
            // Successfully saved user, do any additional tasks like showing success message, navigating to another screen, etc.
    ...
    func saveUserToDatabase(_ user: User) -> Bool {
    ...
    @objc func alreadyHaveAccountLabelTapped() {
        // Navigate to another view controller for existing users
